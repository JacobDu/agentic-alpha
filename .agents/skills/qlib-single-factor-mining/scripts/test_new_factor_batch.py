"""Batch test new candidate factors.
...
def test_new_factors(market: str = "csi1000",
                     ...
                     round_id: str = "SFA-BATCH-NEW",
                     source_tag: str = "Custom") -> pd.DataFrame:
...
def _backfill_to_db(df: pd.DataFrame, market: str,
                    start: str, end: str, round_id: str, source_tag: str) -> None:
...
def main() -> int:
    ...
    parser.add_argument("--round-id", default="SFA-BATCH-NEW",
